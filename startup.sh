...
echo "    bash /root/benchmark_run.sh ollama/qwen3:8b          # run base model benchmark"
echo "    bash /root/benchmark_run.sh ollama/qwen3-8b-gguf-claw  # run fine-tuned benchmark"
